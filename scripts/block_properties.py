    ...
    mapping = BlockMapping.solve(
        {
            ...
            "grass": Flag(blocks("minecraft:short_grass", "minecraft:tall_grass")),
            "top_half": Flag(
                gather_blocks(state_filter=lambda state: state.half == "upper")
            ),
            "bottom_half": Flag(
                gather_blocks(state_filter=lambda state: state.half == "lower")
            ),
            "hanging": Flag(tags["sway/hanging"] + blocks("minecraft:vine")),
            "fire": Flag(blocks("minecraft:fire")),
        },
